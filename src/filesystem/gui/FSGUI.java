    ...
    if(explorer.getSelectedButton() != null)
    {
      ...
      if(rename != null)
      {
        ...
        if(newName != null)
        {
          ...
          else if(rename.getParentDirectory().isRoot())
          {
            explorer.showRootContents(rename.getPreviousNode());
          }
          else if(rename.getParentDirectory().isDirectory())
          {
    ...
    try
    {
      ...
      if(n != null && n.isDirectory() || n.isFile())
      {
        ...
        else
        {
          ...
          if(top != null)
          {
            System.out.println("Deleting: " + n.getNodeName() +
                               "  & selecting: " +
                               n.getNodeName());
            if(top.isRoot())
            {
