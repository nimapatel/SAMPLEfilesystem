...
//  private ButtonIcon currSelectedIcon; //current selected icon e.g my computer
  ...
  public void setSelectedButton(ButtonIcon sb)
  {
    ...
    if(selectedButton != null && selectedButton.getNode() != null)
      lastSelectedNodeButton = selectedButton;
  ...
  //it will be used for bottom toolbar
  public ButtonIcon getLastSelectedNodeButton()
  {
    return lastSelectedNodeButton;
  }
  ...
  public void sendFileTransferRequest(Node n, String dest)
  {
    if(parent.getCoreFS().transferContent(n,dest))
    {
      JOptionPane.showMessageDialog(this,"Done");
    }
    else
    {
        JOptionPane.showMessageDialog(this,"Unable to complete your request");
    }
  }
